export default {
    ...
    "YOUR BOT TOKEN HERE": "这里替换成你的 机器人令牌",
    ...
    Headers: "页眉",
    PushUrl: "Push URL",
    HeadersInvalidFormat: "要求标头不是有效的 JSON：",
    BodyInvalidFormat: "请求主体不是有效的 JSON：",
    "Monitor History": "监测器历史纪录",
    clearDataOlderThan: "保留 {0} 天内的监测器历史纪录。",
    PasswordsDoNotMatch: "密码不相符。",
    records: "记录",
    "One record": "一项记录",
    steamApiKeyDescription: "若要监测 Steam 游戏伺服器，您将需要 Steam Web-API 密匙。您可以在此注册您的 API 密匙：",
    "Current User": "目前使用者",
};
